...
The rules below can be cut and pasted into the _My rules_ pane in the dashboard. (Duplicate rules are removed. You can safely append them at the end of your existing list.)
